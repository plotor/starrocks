...
namespace starrocks::lake::format {
    ...
    class NestedConverter : public ColumnConverter {
        ...
        //
    public:
        NestedConverter(const std::shared_ptr<arrow::DataType> arrow_type,
    ...
    private:
        ...
        template<class SrColumnClass, typename = std::enable_if_t<
                std::is_same_v<SrColumnClass, starrocks::ArrayColumn> ||
        ...
        arrow::Result<std::vector<starrocks::ColumnPtr>> get_children_columns(
            ...
            if constexpr (std::is_same_v<SrColumnClass, starrocks::ArrayColumn>) {
                std::vector<ColumnPtr> all_sub_columns = {data_column->offsets_column(),
                                                          data_column->elements_column()};
        ...
        arrow::Result<std::shared_ptr<arrow::Array>> make_nested_array(const arrow::ArrayVector arrays,
            ...
            if constexpr (std::is_same_v<ArrowArrayClass, arrow::ListArray>) {
                ...
                return arrow::ListArray::FromArrays(_arrow_type, offsets, values,
