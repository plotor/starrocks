...
namespace starrocks::lake::format {
    ...
    public:
        ColumnConverter(const std::shared_ptr<arrow::DataType> arrow_type,
                        const std::shared_ptr<starrocks::Field> sr_field,
                        const arrow::MemoryPool *pool)
    ...
    protected:
        ...
        arrow::Status convert_null_bitmap(const std::shared_ptr<arrow::Buffer>, const std::vector<uint8_t> &null_bytes);
